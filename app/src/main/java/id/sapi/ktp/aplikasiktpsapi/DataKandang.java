...
public class DataKandang extends AppCompatActivity {
    ...
    private void loadJSON() {
        ...
        Call<JSONResponse> call = request.getJSONKandang(3);
...
//            Toast.makeText(HalamanUtama.this, "Terhubung ke internet", Toast.LENGTH_LONG).show();
            ...
            Toast.makeText(DataKandang.this, "Tidak ada koneksi internet", Toast.LENGTH_LONG).show();
        }
    }
}
